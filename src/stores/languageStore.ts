...
const translations: Record<string, Record<Language, string>> = {
  ...
  'verify.checkingEyebrow': { en: 'DOCUMENT VERIFICATION', bn: 'ডকুমেন্ট যাচাইকরণ' },
  ...
  'verify.checkingBody': {
    ...
    bn: 'Somadhan Sign-এর সম্পন্ন রেকর্ড পরীক্ষা করা হচ্ছে।',
  },
  'verify.recordEyebrow': { en: 'RECORD FOUND', bn: 'রেকর্ড পাওয়া গেছে' },
  'verify.recordTitle': { en: 'Completion record found', bn: 'সম্পন্ন রেকর্ড পাওয়া গেছে' },
  'verify.recordBody': {
    en: 'This QR matches an active Somadhan Sign record. Choose the signed PDF to confirm this exact copy.',
    bn: 'এই QR একটি সক্রিয় Somadhan Sign রেকর্ডের সঙ্গে মিলেছে। এই PDF কপিটি হুবহু মিলছে কি না নিশ্চিত করতে স্বাক্ষরিত PDF নির্বাচন করুন।',
  },
  'verify.matchEyebrow': { en: 'EXACT MATCH', bn: 'হুবহু মিলেছে' },
  'verify.matchTitle': {
    en: 'Exact match to the recorded PDF',
    bn: 'সংরক্ষিত PDF-এর সঙ্গে হুবহু মিলেছে',
  },
  'verify.matchBody': {
    en: 'The selected file has the exact same bytes as Somadhan Sign’s recorded completed PDF.',
    bn: 'নির্বাচিত ফাইলের বাইট Somadhan Sign-এ সংরক্ষিত সম্পন্ন PDF-এর সঙ্গে হুবহু একই।',
  },
  'verify.mismatchEyebrow': { en: 'FILE DOES NOT MATCH', bn: 'ফাইলটি মেলেনি' },
  'verify.mismatchTitle': { en: 'This is not the exact recorded PDF', bn: 'এটি সংরক্ষিত PDF-এর হুবহু কপি নয়' },
  'verify.mismatchBody': {
    en: 'The selected file differs from the completed PDF on record. It may have been changed or re-saved.',
    bn: 'নির্বাচিত ফাইলটি সংরক্ষিত সম্পন্ন PDF থেকে আলাদা। এটি পরিবর্তন করা বা আবার সংরক্ষণ করা হয়ে থাকতে পারে।',
  },
  ...
  'verify.revokedEyebrow': { en: 'VERIFICATION WITHDRAWN', bn: 'যাচাইকরণ প্রত্যাহার করা হয়েছে' },
  ...
  'verify.unavailableTitle': { en: 'Verification is temporarily unavailable', bn: 'যাচাইকরণ সাময়িকভাবে অনুপলব্ধ' },
  'verify.unavailableBody': {
    en: 'We could not reach the verification service. This record has not been marked invalid.',
    bn: 'যাচাইকরণ সেবার সঙ্গে সংযোগ করা যায়নি। রেকর্ডটিকে অবৈধ হিসেবে চিহ্নিত করা হয়নি।',
  },
  'verify.offlineBody': {
  ...
  'verify.recordedFileSize': { en: 'Recorded file size', bn: 'সংরক্ষিত ফাইলের আকার' },
  'verify.evidenceFingerprint': { en: 'Completion evidence fingerprint', bn: 'সম্পন্ন প্রমাণের ফিঙ্গারপ্রিন্ট' },
  'verify.copyFingerprint': { en: 'Copy evidence fingerprint', bn: 'প্রমাণের ফিঙ্গারপ্রিন্ট কপি করুন' },
  'verify.evidenceFingerprintNote': {
    en: 'This identifies Somadhan Sign’s server-side completion snapshot. The PDF check below separately compares the exact file bytes.',
    bn: 'এটি Somadhan Sign-এর সার্ভার-সাইড সম্পন্ন স্ন্যাপশট শনাক্ত করে। নিচের PDF পরীক্ষা আলাদাভাবে ফাইলের হুবহু বাইট মিলিয়ে দেখে।',
  },
  'verify.choosePdf': { en: 'Choose the signed PDF', bn: 'স্বাক্ষরিত PDF নির্বাচন করুন' },
  'verify.checkingFile': { en: 'Checking the PDF...', bn: 'PDF পরীক্ষা করা হচ্ছে...' },
  'verify.invalidPdf': {
    en: 'Choose a valid PDF no larger than 30 MB.',
    bn: '৩০ MB-এর বেশি নয় এমন একটি বৈধ PDF নির্বাচন করুন।',
  },
  'verify.localHashNote': {
    en: 'Your PDF stays on this device. Only its SHA-256 fingerprint is compared locally.',
    bn: 'আপনার PDF এই ডিভাইসেই থাকে। শুধু এর SHA-256 ফিঙ্গারপ্রিন্ট এই ডিভাইসে তুলনা করা হয়।',
  },
  'verify.tryAgain': { en: 'Try again', bn: 'আবার চেষ্টা করুন' },
  'verify.disclaimer': {
    en: 'This service confirms the Somadhan Sign completion record and exact PDF bytes. It does not independently determine legal validity or a signer’s identity.',
    bn: 'এই সেবা Somadhan Sign-এর সম্পন্ন রেকর্ড এবং PDF-এর হুবহু বাইট নিশ্চিত করে। এটি আলাদাভাবে আইনি বৈধতা বা কোনো স্বাক্ষরকারীর পরিচয় নির্ধারণ করে না।',
  },
  ...
  'landing.ctaNewDesc': {
    ...
    bn: 'ডকুমেন্ট প্রস্তুত করুন, স্বাক্ষরকারীদের আমন্ত্রণ জানান এবং প্রথম পাঠানো থেকেই পুরো প্রক্রিয়াটি পরিষ্কার রাখুন।',
  },
  ...
  'editor.addAndAnotherSigner': {
    en: 'Add & add another',
    bn: 'যোগ করে আরেকজন স্বাক্ষরকারী লিখুন',
  },
  ...
  'audit.recordedActivity': { en: 'Recorded document activity', bn: 'রেকর্ড করা ডকুমেন্ট কার্যক্রম' },
