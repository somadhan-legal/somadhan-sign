...
const translations: Record<string, Record<Language, string>> = {
  ...
  'verify.recordTitle': { en: 'Completion record is active', bn: 'সম্পন্ন রেকর্ডটি সক্রিয়' },
  'verify.recordBody': {
    en: 'Somadhan Sign has an active completion record for this certificate. Keep the reference below if you need support.',
    bn: 'এই সনদের জন্য Somadhan Sign-এ একটি সক্রিয় সম্পন্ন রেকর্ড রয়েছে। সহায়তার প্রয়োজন হলে নিচের রেফারেন্সটি সংরক্ষণ করুন।',
  },
  ...
  'verify.disclaimer': {
    ...
    bn: 'এই পৃষ্ঠা Somadhan Sign-এর একটি সম্পন্ন রেকর্ড নিশ্চিত করে। এটি আলাদাভাবে আইনি বৈধতা বা কোনো স্বাক্ষরকারীর পরিচয় নির্ধারণ করে না।',
  },
