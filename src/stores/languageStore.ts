...
const translations: Record<string, Record<Language, string>> = {
  ...
  'verify.matchTitle': { en: 'This PDF is verified', bn: 'এই PDF যাচাইকৃত' },
  'verify.matchBody': {
    en: 'The complete PDF matches the SHA-256 fingerprint recorded by Somadhan Sign.',
    bn: 'সম্পূর্ণ PDF-টি Somadhan Sign-এ সংরক্ষিত SHA-256 ফিঙ্গারপ্রিন্টের সঙ্গে মিলেছে।',
  },
